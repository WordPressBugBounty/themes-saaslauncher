			...
			<div class="content-holder">
				<div class="notices">
					<figure class="brand-logo">
						<img width="44" height="44" src="<?php echo esc_url(self::$url . 'images/saaslauncher.png'); ?>" alt="Cozy Blocks logo" />
					</figure>

					<div>
						<h2 class="notice-heading"><?php esc_html_e('Welcome to SaasLauncher! Build Your Professional Website with Ease 🎉', 'saaslauncher'); ?></h2>

						<p><?php esc_html_e('Install and activate Cozy Blocks to unlock advanced customization, powerful custom blocks, and a library of ready-made templates and patterns—all designed to help you build and customize your website faster and easier.
', 'saaslauncher'); ?></p>
						...
						<div class="notice-buttons">
							...
							?>
								<button class="cozy-addons-install notice-button has-spinner">
									<a href="#"><?php esc_html_e('Install & Activate Cozy Blocks →', 'saaslauncher'); ?></a>
