			...
			<div class="is-sticky">
				...
				?>
					<div class="boxed-layout upsell-boxed-layout">
						...
						<p><?php esc_html_e('Unlock powerful tools and advanced customization to build professional websites effortlessly.', 'saaslauncher'); ?></p>
						<ul class="icon-list">
							<li class="list-item">
								<i class="check-icon">
								...
								<?php esc_html_e('50+ Powerful Custom Blocks', 'saaslauncher'); ?>
							</li>
							<li class="list-item">
								<i class="check-icon">
									<svg width="10" height="10" viewBox="0 0 10 10" fill="none"
								...
								<?php esc_html_e('Templates and Patterns Library', 'saaslauncher'); ?>
							</li>
							<li class="list-item">
								<i class="check-icon">
									<svg width="10" height="10" viewBox="0 0 10 10" fill="none"
								...
								<?php esc_html_e('Advanced Gallery with filter & Lightbox', 'saaslauncher'); ?>
							</li>
							<li class="list-item">
								<i class="check-icon">
									<svg width="10" height="10" viewBox="0 0 10 10" fill="none"
								...
								<?php esc_html_e('Portfolio with filter, CPT and multiple layouts', 'saaslauncher'); ?>
							</li>
							<li class="list-item">
								<i class="check-icon">
									<svg width="10" height="10" viewBox="0 0 10 10" fill="none"
								...
								<?php esc_html_e('Dynamic Content & CPTs', 'saaslauncher'); ?>
							</li>
							<li class="list-item">
								<i class="check-icon">
									<svg width="10" height="10" viewBox="0 0 10 10" fill="none"
								...
								<?php esc_html_e('Testimonials & Reviews', 'saaslauncher'); ?>
							</li>
							<li class="list-item">
								<i class="check-icon">
									<svg width="10" height="10" viewBox="0 0 10 10" fill="none"
								...
								<?php esc_html_e('Team & Trust Sections', 'saaslauncher'); ?>
							</li>
							<li class="list-item">
								<i class="check-icon">
									<svg width="10" height="10" viewBox="0 0 10 10" fill="none"
								...
								<?php esc_html_e('Pricing Tables', 'saaslauncher'); ?>
							</li>
							<li class="list-item">
								<i class="check-icon">
									<svg width="10" height="10" viewBox="0 0 10 10" fill="none"
								...
								<?php esc_html_e('Brand Showcase — Highlight clients, partners & integrations.', 'saaslauncher'); ?>
							</li>
							<li class="list-item">
								<i class="check-icon">
									<svg width="10" height="10" viewBox="0 0 10 10" fill="none"
								...
								<?php esc_html_e('13 Pre-Built Inner Page Templates', 'saaslauncher'); ?>
							</li>
							<li class="list-item">
								<i class="check-icon">
									<svg width="10" height="10" viewBox="0 0 10 10" fill="none"
								...
								<?php esc_html_e('One-Click Demo Importer', 'saaslauncher'); ?>
							</li>
						</ul>
