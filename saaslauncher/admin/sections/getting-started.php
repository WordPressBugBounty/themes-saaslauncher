	...
	<div class="boxed-layout steps flex-layout">
		<div class="flex-layout">
			...
			<div>
				...
				<div class="saaslauncher-spacer xs"></div>
				<p><?php esc_html_e('Cozy Blocks unlocks advanced customization, powerful blocks, and ready-made templates and patterns to help you build and customize your website faster and easier.', 'saaslauncher'); ?>
				</p>
			</div>
		</div>
		<?php
