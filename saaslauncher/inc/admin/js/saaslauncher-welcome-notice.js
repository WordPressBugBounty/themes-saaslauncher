(function ($) {
  ...
  $("#install-activate-button").on("click", function (e) {
    ...
    var activationData = {
      ...
      nonce: saaslauncher_localize.nonce,
    };
    $.post(saaslauncher_localize.ajax_url, activationData, function (response) {
      ...
      if (match) {
        ...
        try {
          ...
          if (responseObj.success === true) {
            window.location.href = saaslauncher_localize.redirect_url;
          } else {
            console.log("Error!");
          }
        } catch (error) {
