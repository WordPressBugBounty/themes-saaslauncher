				...
				<div class="info-content">
					<div class="notice-holder">
						...
						<div class="notice-text">
							<p><?php esc_html_e('Please install and activate all recommended plugins to use 40+ advanced blocks, 50+ pre-builts sections, 30+ pre-built starter site demos with one click demo importer. Enhance website building and launch your site within minutes with just a few clicks! - Cozy Addons, Cozy Essential Addons, Advanced Import.', 'saaslauncher'); ?></p>
						</div>
