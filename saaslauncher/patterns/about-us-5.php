...
<div class="wp-block-group alignfull has-background-background-color has-background" style="border-style:none;border-width:0px;margin-top:0;margin-bottom:0;padding-top:7rem;padding-right:var(--wp--preset--spacing--40);padding-bottom:8rem;padding-left:var(--wp--preset--spacing--40)"><!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"blockGap":{"left":"84px"},"margin":{"top":"0","bottom":"64px"}}}} -->
	<div class="wp-block-columns are-vertically-aligned-center" style="margin-top:0;margin-bottom:64px"><!-- wp:column {"verticalAlignment":"center"} -->
		<div class="wp-block-column is-vertically-aligned-center"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
			...
			<h1 class="wp-block-heading has-heading-color-color has-text-color has-link-color has-mega-font-size" style="margin-top:10px;margin-bottom:0;line-height:1.3">
				<?php esc_html_e('Delivering top-tier solutions for over a decade', 'saaslauncher'); ?>
			</h1>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px"}}} -->
			<p style="font-size:18px">
				<?php esc_html_e('Where creativity is more than a process—it is the driving force behind every success story. By blending imagination, expertise, and technology, we create meaningful digital experiences that inspire engagement, deliver results, and help businesses thrive in competitive markets.', 'saaslauncher'); ?>
			</p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:image {"id":5716,"sizeSlug":"full","linkDestination":"none","align":"wide","style":{"border":{"radius":{"topLeft":"24px","topRight":"24px","bottomLeft":"24px","bottomRight":"24px"}},"spacing":{"margin":{"bottom":"44px"}}}} -->
			<figure class="wp-block-image alignwide size-full has-custom-border" style="margin-bottom:44px"><img src="<?php echo esc_url($saaslauncher_images[0]) ?>" alt="" class="wp-image-5716" style="border-top-left-radius:24px;border-top-right-radius:24px;border-bottom-left-radius:24px;border-bottom-right-radius:24px" /></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
	</div>
	...
	<div class="wp-block-columns" style="margin-top:84px"><!-- wp:column -->
		<div class="wp-block-column"><!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"64px"}}} -->
			...
			<!-- wp:paragraph -->
			<p>
				<?php esc_html_e('Project Delivered', 'saaslauncher'); ?>
			</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column"><!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"64px"}}} -->
			...
			<!-- wp:paragraph -->
			<p>
				<?php esc_html_e('Customer Satisfaction', 'saaslauncher'); ?>
			</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
