 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["header"],"patternName":"saaslauncher/header-default","name":"Header Default"},"align":"full","className":"is-style-saaslauncher-sticky-navigation","style":{"spacing":{"blockGap":"0","margin":{"top":"0","bottom":"0"},"padding":{"right":"0","left":"0","top":"0","bottom":"0"}},"color":{"background":"#090a0f"}},"layout":{"type":"constrained","contentSize":"100%"}} -->
<div class="wp-block-group alignfull is-style-saaslauncher-sticky-navigation has-background" style="background-color:#090a0f;margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:group {"className":"saaslauncher-header is-style-default","style":{"spacing":{"padding":{"top":"20px","right":"var:preset|spacing|40","bottom":"20px","left":"var:preset|spacing|40"}},"border":{"bottom":{"width":"0px","style":"none"}}},"backgroundColor":"transparent","layout":{"type":"constrained","contentSize":"1230px"}} -->
