...
/**
 * Title: Homepage Pro
 * Slug: saaslauncher/homepage-pro
...
<main class="wp-block-group has-background-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
    <!-- wp:pattern {"slug":"saaslauncher/saaslauncher-hero"} /-->
    <!-- wp:pattern {"slug":"saaslauncher/saaslauncher-logo-carousel"} /-->
    ...
    <!-- wp:pattern {"slug":"saaslauncher/saaslauncher-testimonial-carousel-pro"} /-->
    <!-- wp:pattern {"slug":"saaslauncher/saaslauncher-pricing-pro"} /-->
