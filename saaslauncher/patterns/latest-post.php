 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["saaslauncher-post"],"name":"Latest News and Articles"},"align":"full","style":{"spacing":{"padding":{"top":"8rem","bottom":"8.5rem","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"background","layout":{"type":"constrained","contentSize":"1360px"}} -->
